...
type UserPaper struct {
	...
	SelectedSummary        string `json:"selected_summary" gorm:"selected_summary"`
	CommentSelectedSummary string `json:"comment_selected_summary" gorm:"comment_selected_summary"`
}
...
type UserLongSummarySubmitRequest struct {
	UserPaperID            int64                `json:"user_paper_id" gorm:"user_paper_id"`
