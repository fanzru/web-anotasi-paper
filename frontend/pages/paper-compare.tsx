...
const Compare = () => {
  ...
  const longSumValue = useSelector(selectLongSumValue);

  const onSubmit = handleSubmit(async (data) => {
    console.log(data);
    const ReqBody = {
      user_paper_id: DataUser[0].user_paper_id,
      selected_summary: data.summary,
      comment_selected_summary: data.comment,
      user_summary: DataUser,
      longsumm_summary: DataLong,
    };

    const res = await toast.promise(
      axiosInstance.post(`/api/tuwien/user-longsumm/submit`, ReqBody),
      {
        pending: 'Loading..',
  ...
  const Dummy: DummyProps[] = [
    { data: 0, type: 'user', text: 'Ini data user', value: DataUser },
    {
      data: 1,
      type: 'longsumm',
